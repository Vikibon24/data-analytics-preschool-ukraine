...
Проведено аналіз кількості закладів дошкільної освіти, місць у них та кількості дітей за регіонами України у 2019–2025 роках.

## Мета і завдання

**Мета:** проаналізувати, як повномасштабне вторгнення 2022 року вплинуло на мережу дошкільної освіти по регіонах, і на основі цього сформувати практичні рекомендації для трьох рівнів — окремих людей/сімей, організацій (дитсадків, бізнесу, громадських об'єднань) та державних органів. 

**Завдання:**
- оцінити загальну динаміку кількості дітей, місць і закладів по Україні;
...
Держстат публікує дані про дошкільну освіту окремими таблицями. Кожна з цих таблиць містить багато різної інформації, для дослідження зіставлено три таблиці:
...
- об'єднання трьох окремих таблиць в одну по регіону й року;
- розрахунок похідних показників — завантаженість закладів (діти/місця), зміна рік до року, зміна мирний vs воєнний період;
...
Порівняння мирного (2019–2021) і воєнного (2022–2025) періодів: діти –23%, місця –8%. Інфраструктура дошкільної освіти не "схлопнулась" разом із падінням кількості дітей — мережа переважно збереглась.
 ...
 ![Діти: мирний vs воєнний період](images/children_peace_vs_war.png) ![Місця: мирний vs воєнний період](images/places_peace_vs_war.png)
...
![Завантаженість садочків 2019-2025](images/occupancy_rate.png) 
...
- **Кореляція між кількістю місць і кількістю дітей залишається сильною** — на графіку «Кореляційний аналіз: Місця vs Діти» майже всі 25 регіонів лягають вздовж однієї прямої лінії. Система в цілому логічна й пропорційна, попри війну.
 ...
 ![Кореляційний аналіз: Місця vs Діти](images/correlation_places_children.png)
