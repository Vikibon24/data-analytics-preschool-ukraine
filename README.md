...
- Фактична кількість дітей зросла на 14% (аномальний стрибок у звітності)
  ...
  ***Причина аномалії 2025 року:** Оскільки народжуваність в Україні у 2022–2025 роках стабільно падала, стрибок у кількості закладів та дітей у 2025 році пояснюється зміною методології обліку (впровадження Постанови КМУ №985 та підключення приватних дитсадків до єдиного реєстру). При цьому кадровий склад вихователів продовжував вибувати.*
